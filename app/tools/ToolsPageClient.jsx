...
const tools = [
  ...
  },
  {
    ...
    name: 'Color Palette Preview Tool',
    description: 'Free palette visualizer — preview brand colors on website, dashboard, landing page and mobile app UI mockups.',
    icon: '🖥️',
  ...
  },
  {
    ...
    description: 'Preview your dashboard color scheme on an admin and SaaS UI mockup with sidebar, KPI cards and charts.',
    icon: '📊',
  ...
  },
  {
    ...
    description: 'Preview landing page color palettes on a marketing mockup — hero, features, CTA buttons and footer.',
    icon: '🚀',
  ...
  },
  {
    ...
    description: 'Preview app color schemes on a phone UI mockup with navigation, cards, lists and tab bar.',
    icon: '📱',
