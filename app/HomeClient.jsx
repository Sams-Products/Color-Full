...
const homeToolCards = [
  {
    ...
    description: 'Build harmonious palettes from one base color and copy hex codes for UI and brand work.',
    swatches: ['#8B5CF6', '#EC4899', '#F59E0B', '#10B981', '#3B82F6'],
  },
  {
    href: '/tools/contrast-checker',
    name: 'Contrast checker',
    description: 'Check text and background pairs for WCAG AA and AAA before you ship.',
    swatches: ['#0F172A', '#F9FAFB', '#4F46E5', '#6B7280', '#374151'],
  },
  {
    href: '/tools/color-mixer',
    name: 'Color Mixing Simulator',
    description: 'Blend two colors with RYB paint-style logic and see mixed hex, RGB, and closest color names.',
    swatches: ['#DC2626', '#2563EB', '#7C3AED', '#EA580C', '#16A34A'],
  },
];
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
            {homeToolCards.map((tool) => (
              <Link
                key={tool.href}
                href={tool.href}
                className="block text-left bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-purple-300 dark:hover:border-purple-600 transition-all overflow-hidden group"
              >
                ...
                <div className="p-5">
                  ...
                  <span className="mt-3 inline-block text-sm font-medium text-purple-600 dark:text-purple-400 group-hover:underline">
                    Open tool →
                  </span>
                </div>
              </Link>
