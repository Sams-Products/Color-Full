...
export const PALETTE_PREVIEW_HUB_SEO = {
  ...
  title: 'Color Palette Preview — See Colors on Real UI (Free)',
  description:
    'Free color palette preview: paste hex codes and see them on website, dashboard, landing page & mobile app mockups instantly. Copy CSS variables. No signup.',
  keywords: [
